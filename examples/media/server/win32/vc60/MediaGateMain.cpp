...
void ResetWindowSize()
{
  ...
  MoveWindow(
      ghAddWindow,
      0,
      mainWinRect.bottom - BUTTON_HEIGHT,
      buttonWidth,
      BUTTON_HEIGHT,
      TRUE);
  ...
  MoveWindow(
      ghItemListWindow,
      gDirectoryWindowWidth + SPLIT_BORDER_WIDTH,
      0,
      itemWindowWidth,
      mainWinRect.bottom,
      TRUE);
...
{
  return CreateFont(
      16, 0, 0, 0, FW_NORMAL, FALSE, FALSE, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, CLIP_DEFAULT_PRECIS, DEFAULT_QUALITY, VARIABLE_PITCH | FF_DONTCARE, "Lucida Sans Unicode");
}
